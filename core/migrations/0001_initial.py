# Generated by Django 5.2.6 on 2025-09-16 14:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.IntegerField(choices=[(1, 'Low'), (2, 'Median'), (3, 'High')], default=2)),
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task', to='core.project')),
                ('watchers', models.ManyToManyField(blank=True, related_name='watching_task', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
